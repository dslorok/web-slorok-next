...
const navigation = [
  ...
  { name: "Layanan", href: "/layanan", icon: "fas fa-store" },
    ...
    <header className="fixed top-0 left-0 w-full h-16 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 z-40 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between">
        <div className="flex items-center space-x-3">
          <Image src="/assets/img/logo.png" alt="Logo Desa" width={40} height={40} className="rounded-full" />
          <span className="text-lg font-semibold text-primary-600 dark:text-primary-400">Desa Slorok</span>
        </div>
